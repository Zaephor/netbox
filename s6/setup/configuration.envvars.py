...
DATABASE = {
    ...
    'PASSWORD': os.getenv('DB_PASSWORD',read_secret('db_password')),           # PostgreSQL password
...
REDIS = {
    'tasks': {
        ...
        'PASSWORD': os.getenv('REDIS_PASSWORD', read_secret('redis_password')),
        'DATABASE': 0,
        'DEFAULT_TIMEOUT': 300,
        'SSL': False,
    },
...
SECRET_KEY = os.getenv('SECRET_KEY',read_secret('secret_key'))
